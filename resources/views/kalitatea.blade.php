     ...
     <nav class="navbar navbar-inverse" role="navigation">
          ...
          <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a onclick="location.href='{{ url('/kokapena') }}'">Kalitatea</a></li>
        ...
        <form action="/kalitate_berria" method="post">
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="pwd">Arduraduna</label>
          ...
          <div class="form-group">
            <div class="col-md-6">
                <label for="pwd">Hasiera data</label>
                <input type="text" class="form-control" id="datepicker1" name="hasiera_data">
            </div>
            <div class="col-md-6">
                <label for="pwd">Bukaera data</label>
                <input type="text" class="form-control" id="datepicker2" name="bukaera_data">
                <br>
            </div>
          </div>
          <div class="form-group">
            <label for="pwd">Almazen kokapena</label>
            <input type="text" class="form-control" name="almazen_kokapena">
          </div>
          <div class="form-group">
            <label for="pwd">Emaitza</label>
            <br>
            <input type="radio" name="emaitza" value="Ondo"> Ondo<br>
            <input type="radio" name="emaitza" value="Txarto"> Txarto<br>
          </div>
