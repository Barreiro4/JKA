     ...
     <nav class="navbar navbar-inverse" role="navigation">
          ...
          <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav">
              <li class="active"><a onclick="location.href='{{ url('/mek_get') }}'">Mekanizatua</a></li>
        ...
        <form action="/mek_berria" method="post">
         <div class="form-group">
          ...
          <div class="form-group">
            <label for="email">Lan deskribapena:</label>
            <input type="text" class="form-control" name="izena">
          </div>
          <div class="form-group">
            <label for="pwd">Langilea</label>
            <select class="form-control" name="langile_id">
                <option value="">Aukeratu langilea...</option>
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="makina_id">
                <option value="">Aukeratu makina...</option>
                @foreach($makinas as $makina)
                   <option value="{{ $makina['makina_id'] }}"> {{ $makina['makina_id'] }}. {{ $makina['izena'] }} </option>
                @endforeach
            </select>
          </div>
            <div class="form-group">
